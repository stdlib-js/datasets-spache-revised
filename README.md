...
```javascript
words = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-spache-revised@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-spache-revised@umd/bundle.js"></script>
```
